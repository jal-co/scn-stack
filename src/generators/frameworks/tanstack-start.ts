...
export function generateTanstackStart(config: ProjectConfig): void {
  ...
  const pkg = {
    ...
    scripts: {
      dev: "vinxi dev",
      build: `${dlx} shadcn@latest build && vinxi build`,
      start: "vinxi start",
...
`
  ...
  writeFile(
    join(dir, "app/routes/__root.tsx"),
